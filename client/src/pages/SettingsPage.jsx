          ...
          <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            {activeTab === 'notifications' && (
              <div className="stat-card animate-slide-in" style={{ padding: '24px' }}>
                ...
                <div style={{ marginBottom: '24px', padding: '16px', borderRadius: '12px', border: `1px solid ${theme === 'dark' ? '#334155' : '#e2e8f0'}`, background: theme === 'dark' ? '#0f172a' : '#f8fafc' }}>
                  <h3 style={{ fontSize: '14px', fontWeight: 600, color: theme === 'dark' ? '#f8fafc' : '#0f172a', marginBottom: '8px' }}>Native Gmail Integration</h3>
                  <p style={{ fontSize: '13px', color: theme === 'dark' ? '#cbd5e1' : '#64748b', marginBottom: '16px', lineHeight: 1.5 }}>
                    Connect your personal Google account to send invoices directly from your own email address instead of the system default.
                  </p>
                  ...
                  {user?.connectedGmail ? (
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <span style={{ fontSize: '14px', fontWeight: 500, color: theme === 'dark' ? '#f8fafc' : '#0f172a' }}>{user.connectedGmail}</span>
                      </div>
                      <button 
                        type="button" 
                        onClick={async () => {
                          ...
                          } catch (err) { toast.error('Error disconnecting Gmail'); }
                        }} 
                    ...
                    <button 
                      ...
                      onClick={() => {
                        const baseUrl = import.meta.env.VITE_API_URL 
                          ...
                          : 'http://localhost:5001';
                        window.location.href = `${baseUrl}/api/gmail/connect?token=${localStorage.getItem('invotrack_token')}`;
                      }}
                      className="btn-secondary"
